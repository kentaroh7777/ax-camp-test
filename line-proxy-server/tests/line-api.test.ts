...
jest.mock('../src/services/line-api.service');
const MockedLineApiService = LineApiService as jest.MockedClass<typeof LineApiService>;

describe('LINE API Routes', () => {
  let mockLineApiService: jest.Mocked<LineApiService>;
  ...
  beforeEach(() => {
    ...
    mockLineApiService = new MockedLineApiService() as jest.Mocked<LineApiService>;
