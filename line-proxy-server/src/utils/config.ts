import { AppConfig, DEFAULT_CONFIG_VALUES } from '../types/config.types';
...
const loadConfig = (): AppConfig => {
  ...
  const LOG_LEVEL = (getEnv('LOG_LEVEL', DEFAULT_CONFIG_VALUES.LOG_LEVEL) as 'error' | 'warn' | 'info' | 'debug' | 'verbose');
