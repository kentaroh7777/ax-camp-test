...
import { LineApiService } from '../services/line-api.service.js';
import { authMiddleware } from '../middleware/auth.middleware.js';
import { validationMiddleware } from '../middleware/validation.middleware.js';
import { logger } from '../utils/logger.js';
import { ApiError } from '../types/api.types.js';
import { messageCache } from '../services/message-cache.js';
...
// Get cached messages endpoint
router.get('/messages',
  authMiddleware,
  async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      logger.info('LINE API: Get cached messages request', {
      ...
      const cachedMessages = messageCache.get(since, 'line');
